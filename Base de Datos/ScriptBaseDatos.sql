...
-- -----------------------------------------------------
-- Table `sistemaPrestamos`.`Ejemplar`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistemaPrestamos`.`Ejemplar` (
  `codigoDispositivo` INT(15) NOT NULL,
  `consecutivo` INT(2) NOT NULL,
  `estado` VARCHAR(10) NOT NULL,
  `observaciones` VARCHAR(200) NULL,
  PRIMARY KEY (`codigoDispositivo`, `consecutivo`),
  INDEX `fk_Ejemplar_Dispositivo_idx` (`codigoDispositivo` ASC),
  CONSTRAINT `fk_Ejemplar_Dispositivo`
...
CREATE TABLE IF NOT EXISTS `sistemaPrestamos`.`Reserva` (
  `codigo` INT(15) NOT NULL AUTO_INCREMENT,
  `codigoEjemplarDispositivo` INT(15) NOT NULL,
  `consecutivoEjemplar` INT(2) NOT NULL,
  ...
  PRIMARY KEY (`codigo`),
  INDEX `fk_Reserva_Ejemplar1_idx` (`codigoEjemplarDispositivo` ASC, `consecutivoEjemplar` ASC),
  INDEX `fk_Reserva_Usuario1_idx` (`investigador` ASC),
  INDEX `fk_Reserva_Usuario2_idx` (`administradorAprueba` ASC),
  CONSTRAINT `fk_Reserva_Ejemplar1`
    FOREIGN KEY (`codigoEjemplarDispositivo` , `consecutivoEjemplar`)
    REFERENCES `sistemaPrestamos`.`Ejemplar` (`codigoDispositivo` , `consecutivo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `sistemaPrestamos`.`Usuario_has_Rol`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistemaPrestamos`.`Usuario_has_Rol` (
  `usuario` VARCHAR(30) NOT NULL,
  `rol` INT(3) NOT NULL,
  PRIMARY KEY (`usuario`, `rol`),
  INDEX `fk_Usuario_has_Rol_Rol1_idx` (`rol` ASC),
  INDEX `fk_Usuario_has_Rol_Usuario1_idx` (`usuario` ASC),
